...
public class CategoriesModelNouveaux {
    ...
    public CategoriesModelNouveaux(String decription_du_produit, String date_de_publication, String nom_du_produit, String prix_du_produit, String image_du_produit, String user_image) {
